package piglet.piglet2spiglet.visitor;
...
public class VisitorTranslateM2SP extends GJDepthFirst<PigletCodeAbstract, EntryInfo> implements ResourceManager{
	private int tempIndex;
	private int labelIndex;
	private OutputStream out;
	private Vector<PigletCodeSet> messageSendParasVecCodeSet;
	
	public VisitorTranslateM2SP(OutputStream out)
	{
		this.tempIndex = 21;
		this.labelIndex = 0;
		this.out = out;
	...
	*/
	public PigletCodeAbstract visit(MainClass n, EntryInfo argu)//argu should be a topTable
	{
		...
		EntryInfoClassM2SP classInfo = SymbolTableM2SP.symbolTableM2SP.get(argu.get_main_class());
	...
	*/
	public PigletCodeAbstract visit(ClassDeclaration n, EntryInfo argu)
	{
		...
		EntryInfoClassM2SP classInfo = (EntryInfoClassM2SP) argu.c_get_m2sp(n.f1.f0.tokenImage);
	...
	*/
	public PigletCodeAbstract visit(MethodDeclaration n, EntryInfo argu)
	{
		...
		EntryInfoMethodM2SP methodInfo = (EntryInfoMethodM2SP) argu.m_get_m2sp(n.f2.f0.tokenImage);
	...
	*/
	public PigletCodeAbstract visit(AssignmentStatement n, EntryInfo argu)
	{
		...
		PigletCodeSet IDInfo = ((EntryInfoMethodM2SP) argu).get_variable_info(n.f0.f0.tokenImage, this);
	...
	*/
	...
	{
		PigletCodeSet ret = new PigletCodeSet();
		PigletCodeSet IDCodeSet = ((EntryInfoMethodM2SP) argu).get_variable_info(n.f0.f0.tokenImage, this);
	...
	*/
	public PigletCodeAbstract visit(MessageSend n, EntryInfo argu)
	{
		...
		EntryInfoClassM2SP classInfo = SymbolTableM2SP.symbolTableM2SP.get(instBelongClassName);
		...
		String rtnType = classInfo.m_get_m2sp(n.f2.f0.tokenImage).get_rtn_type();
	...
	*/
	...
	{
		PigletCodeSet ret = ((EntryInfoMethodM2SP) argu).get_variable_info(n.f0.tokenImage, this);
		return ret;
	}
	...
	*/
	public PigletCodeSet visit(ThisExpression n, EntryInfo argu)
	{
		...
		ret.set_temp_address(tempCode);
		ret.set_memory_address(null);
		ret.set_value_type(((EntryInfoMethodM2SP) argu).get_belong_class_name());
		return ret;
	}
	...
	*/
	...
	{
		PigletCodeSet ret = new PigletCodeSet();
		EntryInfoClassM2SP classInfo = SymbolTableM2SP.symbolTableM2SP.get(n.f1.f0.tokenImage);
